...
insert into employee (id, name, position, email, password, roles, enabled) values
    (1, 'HeitorMatsui', 'Coordenador', 'HeitorMatsui', '$2a$10$M7OAYIGqApcaVQ8P2Th2Wef.pt1wTYdHBRwT7Q9XE8V3BHo37bfZe', 'ROLE_USER,ROLE_ADMIN', true),
    (2, 'BrunoMuniz', 'Coordenador', 'BrunoMuniz', '$2a$10$M7OAYIGqApcaVQ8P2Th2Wef.pt1wTYdHBRwT7Q9XE8V3BHo37bfZe', 'ROLE_USER,ROLE_ADMIN', true),
    (3, 'FelipeBanzai', 'Analista de Sistemas', 'FelipeBanzai', '$2a$10$M7OAYIGqApcaVQ8P2Th2Wef.pt1wTYdHBRwT7Q9XE8V3BHo37bfZe', 'ROLE_USER,ROLE_ADMIN', true),
    (4, 'CiroBottini', 'Analista de Sistemas', 'CiroBottini', '$2a$10$M7OAYIGqApcaVQ8P2Th2Wef.pt1wTYdHBRwT7Q9XE8V3BHo37bfZe', 'ROLE_USER,ROLE_ADMIN', true);
